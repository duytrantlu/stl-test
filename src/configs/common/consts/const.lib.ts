...
export class ConstLib {
  ...
  static readonly SYSTEM_IDENTIFY: string = 'SETEL';
  static readonly DEFAULT: any = {
    SYSTEM_IDENTIFY: 'SETEL',
    COUNTRY_CODE: 'us'
  };
  ...
  static readonly TEMPLATES = {
    REGISTER: {
      KEY: 'register',
      SUBJECT: 'Welcome to VMO dev team.'
    }
  };
  ...
  static readonly ERROR_MESSAGE_DEFAULT_SYSTEM: string = 'An error has arisen from the system. Please try again later or contact us for a fix.';
  static readonly LOGGER_GRAY_HTTP_WARNING = '[LOGGER] type "gray-http" is disable. Not recommended. In this state, errors and exceptions will ' +
